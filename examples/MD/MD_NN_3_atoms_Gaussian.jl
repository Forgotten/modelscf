# scriopt to test that the electron density generated by neural network
# using the Gaussian projection of the position of the atoms
# 
using PyCall
using PyPlot
...
filename = "NN_MD_SCF_3_Gaussian.py"
